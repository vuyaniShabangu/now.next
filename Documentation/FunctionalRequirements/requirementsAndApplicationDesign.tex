...
\subsubsection{Use cases}
		...
		\begin{flushleft}
			\textbf{Critical}
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{functionalRequirementsDeleteMissionUseCaseDiagram.jpg}  \\
			...
			\textbf{Nice-To-Have}
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{functionalRequirementsEditmissinUsecaseDiagram.jpg}  \\
					\caption{Use case : viewMission}
				\end{figure}
		\end{flushleft}
\end{document}
